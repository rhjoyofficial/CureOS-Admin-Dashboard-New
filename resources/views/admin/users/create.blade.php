    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <!-- Doctor Specific Fields (Hidden by default, shown when role is Doctor) -->
                <div id="doctor-fields" class="space-y-4 hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="qualifications" id="qualifications" rows="3"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('qualifications') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="experience" id="experience" rows="3"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('experience') }}</textarea>
                            @error('experience')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
