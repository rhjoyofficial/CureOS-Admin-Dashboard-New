        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900">Edit Patient: {{ $patient->name }}</h2>
            ...
            <!-- Form -->
            <form action="{{ route('admin.patients.update', $patient) }}" method="POST" class="p-6 space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="blood_group" id="blood_group"
                                ...
                                <option value="A+"
                                    {{ old('blood_group', $patient->blood_group) == 'A+' ? 'selected' : '' }}>A+</option>
                                <option value="A-"
                                    {{ old('blood_group', $patient->blood_group) == 'A-' ? 'selected' : '' }}>A-</option>
                                <option value="B+"
                                    {{ old('blood_group', $patient->blood_group) == 'B+' ? 'selected' : '' }}>B+</option>
                                <option value="B-"
                                    {{ old('blood_group', $patient->blood_group) == 'B-' ? 'selected' : '' }}>B-</option>
                                <option value="AB+"
                                    {{ old('blood_group', $patient->blood_group) == 'AB+' ? 'selected' : '' }}>AB+</option>
                                <option value="AB-"
                                    {{ old('blood_group', $patient->blood_group) == 'AB-' ? 'selected' : '' }}>AB-</option>
                                <option value="O+"
                                    {{ old('blood_group', $patient->blood_group) == 'O+' ? 'selected' : '' }}>O+</option>
                                <option value="O-"
                                    {{ old('blood_group', $patient->blood_group) == 'O-' ? 'selected' : '' }}>O-</option>
                                <option value="Unknown"
                                    {{ old('blood_group', $patient->blood_group) == 'Unknown' ? 'selected' : '' }}>Unknown
                                </option>
                            </select>
                            @error('blood_group')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="husband_wife_name" id="husband_wife_name"
                                value="{{ old('husband_wife_name', $patient->husband_wife_name) }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="religion" id="religion"
                                ...
                                <option value="Islam"
                                    {{ old('religion', $patient->religion) == 'Islam' ? 'selected' : '' }}>Islam</option>
                                <option value="Hinduism"
                                    {{ old('religion', $patient->religion) == 'Hinduism' ? 'selected' : '' }}>Hinduism
                                </option>
                                <option value="Christianity"
                                    {{ old('religion', $patient->religion) == 'Christianity' ? 'selected' : '' }}>
                                    Christianity</option>
                                <option value="Buddhism"
                                    {{ old('religion', $patient->religion) == 'Buddhism' ? 'selected' : '' }}>Buddhism
                                </option>
                                <option value="Other"
                                    {{ old('religion', $patient->religion) == 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="division" id="division"
                                value="{{ old('division', $patient->division) }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="upazila" id="upazila"
                                value="{{ old('upazila', $patient->upazila) }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="post_office" id="post_office"
                                value="{{ old('post_office', $patient->post_office) }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="full_address" id="full_address" rows="2"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('full_address', $patient->full_address) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="nid" class="block text-sm font-medium text-gray-700 mb-1">National ID
                                (NID)</label>
                            <input type="text" name="nid" id="nid" value="{{ old('nid', $patient->nid) }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('nid')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="birth_certificate_no" id="birth_certificate_no"
                                value="{{ old('birth_certificate_no', $patient->birth_certificate_no) }}"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="active"
                                    {{ old('status', $patient->status) == 'active' ? 'selected' : '' }}>Active</option>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="allergies" id="allergies" rows="2" placeholder="List any known allergies..."
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('allergies', $patient->allergies) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="current_medications" id="current_medications" rows="2"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('current_medications', $patient->current_medications) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="past_medical_history" id="past_medical_history" rows="2"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('past_medical_history', $patient->past_medical_history) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="family_medical_history" id="family_medical_history" rows="2"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('family_medical_history', $patient->family_medical_history) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="habits" id="habits" rows="2" placeholder="Smoking, alcohol consumption, exercise, etc..."
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('habits', $patient->habits) }}</textarea>
                        </div>
                    </div>
                </div>
