    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mb-4">
            ...
            <div class="relative flex items-center">
                <input type="password" id="password_input" name="password" required autocomplete="new-password"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
        ...
        <div class="mb-6">
            ...
            <div class="relative flex items-center">
                <input type="password" id="password_confirmation_input" name="password_confirmation" required
