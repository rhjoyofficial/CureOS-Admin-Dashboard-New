...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('nid')->nullable()->unique()->comment('National ID for Bangladeshi users');
            ...
            // Add for doctors
            $table->string('bmdc_registration')->nullable()->unique()->comment('BMDC Registration for Bangladeshi doctors');
